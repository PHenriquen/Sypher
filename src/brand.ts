...
export const divisions: Division[] = [
  {
    ...
    color: "#E53935",
    colorSoft: "#FF8A80",
    motif: "Open cell / prototype / research structure",
    mark: "/brand/divisions/labs.svg",
    markName: "Open Cell",
    tone: "Experimental, technical, direct and deliberately unfinished.",
  ...
  },
  {
    ...
    color: "#00D6FF",
    colorSoft: "#70E7FF",
    motif: "Core / presence / controlled light",
  ...
  },
  {
    ...
    color: "#00C896",
    colorSoft: "#85FFDE",
    motif: "Layers / modules / shipped software",
  ...
  },
  {
    ...
    color: "#FFD200",
    colorSoft: "#FFF0A3",
    motif: "Input / response / pixel play",
    mark: "/brand/divisions/interactive.svg",
    markName: "Dual Input",
    tone: "Playful, authored, responsive and unmistakably interactive.",
    keywords: ["game", "experience", "play"],
  },
];
